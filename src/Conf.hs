...
confOpt = Conf {
           ...
           , hackageDirOpt = "/tmp/hackage" &= explicit  &= name "hackage_dir" &= typDir &= help "Set the hackage archive directory"
           , hackageLogOpt = "./hackage.log" &= explicit  &= name "hackage_log" &= typFile &= help "Set the hackage archive log file"
